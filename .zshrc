...
# -------------------------------------------------------------------
# save local ~/.zshrc to github
# -------------------------------------------------------------------
save-zshrc() {
  cprf "$HOME/.zshrc" "$USR_SRC_GIST_ROOT/$GIST_ZSHRC_ID/.zshrc"
...
# -------------------------------------------------------------------
update-zshrc() {
  update-gist "$GIST_ZSHRC_ID" "$HOME/.zshrc"
}
...
# -------------------------------------------------------------------
update-vimrc() {
  update-gist "$GIST_VIMRC_ID" "$HOME/.vimrc"
}
